...
<head>
    ...
    <style>
        #map { height: 450px; width: 100%; border-radius: 10px; border: 2px solid #0d6efd; }
        .nav-radar { background-color: #0d6efd; }
        .form-label { font-weight: bold; color: #0d6efd; }
        .leaflet-popup-content-wrapper { border-left: 5px solid #0d6efd; }
    </style>
</head>
<body class="bg-light">
